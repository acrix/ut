...
function main()
{
  ...
  main.rasp = {
    0: 0,
    1: [
         { 0: [08, 00], 1: [08, 40], 2: "8В Русский язык А403" },
         { 0: [08, 50], 1: [09, 30], 2: "8Д Русский язык 401" },
         { 0: [09, 40], 1: [10, 20], 2: "8Д Родная литература 401" },
         { 0: [10, 35], 1: [11, 15], 2: "8В Родная литература А403" },
         { 0: [11, 35], 1: [12, 15], 2: "5А Русский язык А421" },
         { 0: 0 }
       ],
    2: [
         { 0: 0 },
         { 0: [08, 50], 1: [09, 30], 2: "5А Русский язык А421" },
         { 0: [09, 40], 1: [10, 20], 2: "8В Русский язык А403" },
         { 0: 0 },
         { 0: [11, 35], 1: [12, 15], 2: "5А Русский язык А421" },
         { 0: 0 }
       ],
    3: [
         { 0: [08, 00], 1: [08, 40], 2: "5А Русский язык А421" },
         { 0: [08, 50], 1: [09, 30], 2: "8В Русский язык А403" },
         { 0: [09, 40], 1: [10, 20], 2: "8Д Русский язык 401" },
         { 0: [10, 45], 1: [11, 25], 2: "5А Литература А421" },
         { 0: [11, 25], 1: [12, 05], 2: "8Д Литература 401" },
         { 0: [12, 15], 1: [12, 55], 2: "8В Литература А403" }
       ],
    4: [
         { 0: [08, 00], 1: [08, 40], 2: "8Д Русский язык 401" },
         { 0: 0 },
         { 0: [09, 45], 1: [10, 25], 2: "5А Родная литература А421" },
         { 0: 0 },
         { 0: 0 },
         { 0: 0 }
       ],
    5: [
         { 0: [08, 00], 1: [08, 40], 2: "5А Русский язык А421" },
         { 0: [08, 50], 1: [09, 30], 2: "8В Русский язык А403" },
         { 0: [09, 45], 1: [10, 25], 2: "5А Литература А421" },
         { 0: [10, 35], 1: [11, 15], 2: "8Д Русский язык 401" },
         { 0: [11, 25], 1: [12, 05], 2: "8В Литература А403" },
         { 0: [12, 15], 1: [12, 55], 2: "8Д Литература 401" }
       ],
    6: 0
  }
